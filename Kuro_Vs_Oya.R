KuroshioWaters <- div.abiotic2[which(div.abiotic2$S >=34.2),]
OyashioWaters <- div.abiotic2[which(div.abiotic2$S <=33.5),]
...
#
MixedWater <- div.abiotic2[which(div.abiotic2$S >=33.51),]
